...
<section class="header">
  ...
  <nav>
      <ul class="topnav" id="myTopnav">
        ...
        <li><a href="category.php?cat_id=1">Hunting</a></li>
        <li><a href="category.php?cat_id=2" <?php if ($currentPage == 'fishing.php') { echo 'id="current"';} ?>>Fishing</a></li>
        <li><a href="category.php?cat_id=3" <?php if ($currentPage == 'camping.php') { echo 'id="current"';} ?>>Camping</a></li>
