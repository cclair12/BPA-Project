  ...
  <div class="eight columns offset-by-two">
	...
	<form method="post" name="submit_an_idea" enctype="multipart/form-data" action="">
      ...
      <?php if ($missing && in_array('project_steps', $missing)) { ?>
          ...
          <?php } ?></label>
		<textarea for="project_steps" placeholder="Please List Project Steps In Order"></textarea>
		<label for="uploaded_file">Select A File To Upload: <strong class="tip">&#42;</strong>
      <?php if ($missing && in_array('lastName', $missing)) { ?>
          <span class="tip">Please upload the images for your project.</span>
          <?php } ?></label>
	</form>
     </div>
   </div>
