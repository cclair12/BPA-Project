...
<div class="container">
    ...
    <div class="eight columns materials">
      ...
      <label><input type="checkbox" class="mats"><span>Flame source, preferably a torch or gas stove stop.</span></label>
...
<div class="row">
  ...
  <div class="row">
    ...
    <div class="row">
    <div class="eight columns">
      <p><span class="steps">Step 5</span><br> After the two pieces are tied together, reheat your nail. Carefully add additional holes around bottle A, around a dozen or so. This will help keep your trap near the bottom of the lake.</p>
    </div>
    </div><!--row-->
    <div class="row">
    <div class="eight columns">
